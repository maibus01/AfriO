        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
          <div>
            ...
            <p className="text-slate-500 mt-1 font-medium">
              Control your storefront URLs and info
            </p>
          </div>
            ...
            >
              ...
              <div className="pt-12 pb-8 px-8">
                <div className="flex justify-between items-start">
                  <div>
                    <h2 className="text-2xl font-black text-slate-800 group-hover:text-orange-600 transition-colors">
                      {b.name}
                    </h2>
                    <span
                      className={`inline-block px-3 py-1 rounded-full text-[10px] uppercase tracking-widest font-black mt-2 ${b.category === "tailor" ? "bg-purple-50 text-purple-600" : "bg-blue-50 text-blue-600"}`}
                    >
                      {b.category}
                    </span>
                  </div>
            ...
            <div className="relative bg-white rounded-[3rem] shadow-2xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in duration-200">
              <div className="p-8 border-b border-slate-50 flex justify-between items-center">
                <h2 className="text-2xl font-black text-slate-800">
                  {editId ? "Update Profile" : "Launch Store"}
                </h2>
                <button
                  onClick={closeModal}
              ...
              <div className="p-8 space-y-4 max-h-[70vh] overflow-y-auto">
                <div className="space-y-4">
                  <label className="block">
                    <span className="text-xs font-black uppercase text-slate-400 ml-2">
                      Business Name
                    </span>
                    <input
